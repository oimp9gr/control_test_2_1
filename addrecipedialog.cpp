    ...
    recipe({"", {{"", 0}}})
{
    ...
    connect(ui->i1_spinBox, QOverload<int>::of(&QSpinBox::valueChanged), [=] (int value) { updateRecipeWeight(1, value); });
}
...
void AddRecipeDialog::on_add_pushButton_clicked()
{
    ...
    connect(i_n_spinBox, QOverload<int>::of(&QSpinBox::valueChanged), [=] (int value) { updateRecipeWeight(number, value); });
}
